<?php
/**
 * class-groups-newsletters-widget.php
 *
 ...
 * Newsletters widget.
 */
class Groups_Newsletters_Widget extends WP_Widget {

	/**
	 * @var string cache id
	 */
	static $cache_id = 'groups_newsletters_widget';
...
// 		}
	...
	static function widgets_init() {
		register_widget( 'Groups_Newsletters_Widget' );
	}
	...
	function __construct() {
		parent::__construct( false, $name = 'Newsletters' );
	}
	...
	public static function render( $instance ) {
		return Groups_Newsletters_Shortcodes::groups_newsletters( $instance );
	}
}
Groups_Newsletters_Widget::init();
